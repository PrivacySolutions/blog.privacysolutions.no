...
Lastly, update from Gnosis!

( - Actually copied from a draft from Gnosis and rewrote it a bit, but newsworthy so I'm posting it. /Meeh)

Gnosis wanted to give an update on the UFO project: it is ongoing and will  finish on September 15, when ANC rewards will be issued and the server source will be published to our <a href="https://github.com/Anoncoin" target="_blank">Github</a>. The largest factor found so far is 143551628346878317311308640667091515671003679, which is 45 digits (147 bits). For some perspective, the world record for factors found using this method is 78 digits (though for all we know, the NSA/GCHQ/$spooky-agency have factored larger ones...). I'd like to thank all the participants for contributing their CPU core-months (core-years, in some cases) to this project -- this effort was essential for creating a trustless <a href="https://wiki.anoncoin.net/Zerocoin" target="_blank">Zerocoin</a> implementation using <a href="https://wiki.anoncoin.net/RSA_UFO" target="_blank">RSA UFOs</a>.
