...
Once we implement ZeroCoin into MainNet, we probably send another round of payments for those who continued to run ufo_client.

K1773R is currently investigating on some transaction issues that have happended as a result of exchanges sending the wallet dust, resulting in transactions over 100Kb.
